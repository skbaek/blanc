...
theorem triggerAuthorizedContinuation_paused_route
  ...
  have pBalance0 := prefix_of_push_stack (of_run_selfbalance_stack rbalance) pCallvalue
  ...
  have pBalance2 :=
    prefix_of_push_stack (of_run_selfbalance_stack rbalance2) pCallvalue2
...
theorem triggerFullWithdrawals_selected_paused_not_ok
  ...
  · have balanceRun := authorizedRun
    ...
    have pBalance0 :=
      prefix_of_push_stack (of_run_selfbalance_stack rbalance) pCallvalue
