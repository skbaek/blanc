...
theorem subtree1165_rows_checked :
    subtree1165.all (checkRow code.toByteArray table 8) = true := by
  decide +kernel

theorem subtree1165_layout_checked :
    subtree1165.checkLayout code.toByteArray 1157 1182 = true := by
  decide +kernel

theorem subtree1156_rows_checked :
    subtree1156.all (checkRow code.toByteArray table 8) = true := by
  apply Table.all_node
  · decide +kernel
  · exact subtree1148_rows_checked
  · exact subtree1165_rows_checked

theorem subtree1156_layout_checked :
    subtree1156.checkLayout code.toByteArray 1140 1182 = true := by
  apply Table.checkLayout_node (next := 1157)
  · decide +kernel
  · exact subtree1148_layout_checked
  · exact subtree1165_layout_checked
  · decide +kernel

theorem subtree1137_rows_checked :
    subtree1137.all (checkRow code.toByteArray table 8) = true := by
  apply Table.all_node
  · decide +kernel
  · exact subtree1125_rows_checked
  · exact subtree1156_rows_checked

theorem subtree1137_layout_checked :
    subtree1137.checkLayout code.toByteArray 1110 1182 = true := by
  apply Table.checkLayout_node (next := 1140)
  · decide +kernel
  · exact subtree1125_layout_checked
  · exact subtree1156_layout_checked
  · decide +kernel

theorem subtree1097_rows_checked :
    subtree1097.all (checkRow code.toByteArray table 8) = true := by
  apply Table.all_node
  · decide +kernel
  · exact subtree1054_rows_checked
  · exact subtree1137_rows_checked

theorem subtree1097_layout_checked :
    subtree1097.checkLayout code.toByteArray 1023 1182 = true := by
  apply Table.checkLayout_node (next := 1110)
  · decide +kernel
  · exact subtree1054_layout_checked
  · exact subtree1137_layout_checked
  · decide +kernel
...
theorem subtree1022_rows_checked :
  ...
  apply Table.all_node
  · decide +kernel
  · exact subtree942_rows_checked
  · exact subtree1097_rows_checked
...
theorem subtree1022_layout_checked :
  ...
  · decide +kernel
  · exact subtree942_layout_checked
  · exact subtree1097_layout_checked
  · decide +kernel
