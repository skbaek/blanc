...
def recipes : List Recipe := [
  ...
  {
    id := "binary-dispatch-miss"
    status := "active"
    triggers := ["goal-shape:raw-sstore-free-compiled-path"]
    preferredPath := "For an unmatched selector in a `DispatchTree`, prove `¬ tree.HasSelector selector` and apply `DispatchTree.dispatchMiss_runCompiledTo_with_path`. The result is the exact selector-dependent empty-revert `RunCompiledTo` paired with `NoRawSstorePath` for that identical proof; `DispatchTree.dispatchMissGas` names its exact cost."
    symbols := ["module:Blanc/ForwardDispatchMiss.lean", "declaration:Blanc.DispatchTree.HasSelector", "declaration:Blanc.DispatchTree.dispatchMissGas", "declaration:Blanc.DispatchTree.dispatchMiss_runCompiledTo_with_path"]
  ...
  },
  {
    ...
    symbols := ["module:Blanc/CommonProofs.lean", "declaration:Devm.memWrite_memory", "declaration:Devm.memWrite_stack", "declaration:Devm.addAccessedStorageKey_setMach_setMach", "declaration:Devm.getStorVal_setStorVal_self", "declaration:Devm.setStorVal_getCode", "declaration:Devm.setCode_logs", "declaration:Devm.setCode_output", "declaration:Devm.setCode_error", "declaration:Devm.retPost_getStorVal", "declaration:Devm.retPost_accessedStorageKeys", "declaration:Devm.sstoreBase_state", "declaration:Devm.sstoreBase_accessedStorageKeys", "declaration:Devm.sstoreWarmBase_accessedStorageKeys", "module:Blanc/AddressSlot.lean", "module:Blanc/AddressSlotProofs.lean", "declaration:addressSlotReadWord", "declaration:addressSlotWriteWord", "declaration:addressSlotReadWord_eq_toAdr_toB256", "declaration:of_loadAddressWordAt_val", "declaration:of_storeAddressWordAt_val"]
  ...
  },
  {
    ...
    symbols := ["module:Blanc/RevertPayload.lean", "declaration:Blanc.errorBodyCost", "declaration:Blanc.errorCallCost", "declaration:Blanc.errorGuardCost", "declaration:Blanc.errorGuardCost_congr_memory_size", "declaration:Blanc.Func.runCompiledTo_revWith", "declaration:Blanc.Func.runCompiledTo_errorGuard"]
