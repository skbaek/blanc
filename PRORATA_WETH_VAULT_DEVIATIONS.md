...
row. The compiled-reference differential establishes agreement on its declared
finite matrix — 129 required cases, of which 125 are implemented and 4 are
superseded by named implemented successors, none unimplemented
(`scripts/prorata_weth_vault_differential_matrix.py`) — and nowhere it does
