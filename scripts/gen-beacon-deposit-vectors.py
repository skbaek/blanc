...
# differential became the third consumer of this file's copy.  This wrapper
# keeps the hex-returning spelling the rest of this generator uses.
sys.path.insert(0, str(Path(__file__).resolve().parent))
from keccak import keccak256 as _keccak256  # noqa: E402


def keccak256(data: bytes) -> str:
    """This generator's spelling: bare hex, no `0x` prefix."""
