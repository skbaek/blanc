...
| the DRIP BPO2 fixture generator, block/observer helpers, generated fixture population, or external consumer wrapper | `scripts/check-current-mainnet.sh` then `scripts/check-drip-current-mainnet.sh` | the **full set**, in the order below |
