...
| `scripts/check-cycle-write-free.sh --static-only` | exact owner/signature/exemption manifest and contract-wide shadow/alias/export controls | 22 positive proof pins; 19 owners; 7 signatures; parser controls | ~45 s (ledger median of 12 record(s), imported 2026-09-23) |
| `scripts/check-transient-settlement.sh --static-only` | sole shared owner, exact imports/signatures, donor moves, touched consumers and frozen predecessor assurances | 14 owners; 12 moved donors | ~9 s (ledger median of 12 record(s), imported 2026-09-23) |
...
| `scripts/check-execution-occurrence.sh --semantic-only --composed-prerequisites` | compiled occurrence/direct-code positives and mutants after consuming settlement evidence | 22 controls; 22 Lean mutants; live positive deletions | ~323 s (ledger median of 9 record(s), imported 2026-09-23) |
| `scripts/check-cycle-write-free.sh --semantic-only` | concrete evaluator and diagnostic-pinned Lean mutants | 23 evaluator controls; 20 Lean mutants | ~38 s (ledger median of 12 record(s), imported 2026-09-23) |
| `scripts/check-transient-settlement.sh --semantic-only` | concrete evaluator, mutants and live positive-deletion controls | 25 evaluator controls; 22 Lean mutants | ~6 s (ledger median of 12 record(s), imported 2026-09-23) |
...
| `scripts/check-execution-occurrence.py` | `check-execution-occurrence.sh` | compiles 16 concrete occurrence controls plus six kernel-only actual-spawn direct-code controls, parser-pins 26 public proofs and seven exact direct-code propositions with live deletion controls, runs 20 occurrence mutants and the CREATE/CALLCODE premise-deletion mutants with diagnostic pins, pins the exact common direct-code header, sole owner, retired name, and 1/1/2/1 WETH/Lido consumer inventory, rejects canonical/retired shadows, aliases, exports, and unrelated-name proposition copies across WETH10/Lido fail-closed, retains the historical ownership/parser falsifiers, composes the raw-attribution chronology ownership/signature/kernel audit, then composes the two CREATE raw-retention falsifiers |
