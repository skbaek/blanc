...
| `scripts/check-lido-circuit-breaker-registry.sh --semantic-only` | compiled Registry positives, mutants and exact axiom rows; each fixture is elaborated once, with the `#print axioms` probes it owns appended to the compiled copy | 3 concrete exact-code controls; 7 storage mutants; 4 axiom rows; 2 elaborations (was 6) | ~25 s (measured 2026-09-24; was 74 s) |
