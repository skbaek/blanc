...
| `scripts/check-layering.sh` | contracts are siblings in the import hierarchy: no cross-contract import, no shared module importing a contract (rule and rationale in `README.md`) | 7 contracts, 187 modules, 185 non-root | sub-second |
