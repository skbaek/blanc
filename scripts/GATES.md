...
| `scripts/check-layering.sh` | contracts are siblings in the import hierarchy: no cross-contract import, no shared module importing a contract (rule and rationale in `README.md`) | 8 contracts, 224 modules, 222 non-root | sub-second |
