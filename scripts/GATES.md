...
| `scripts/check-layering.sh` | contracts are siblings in the import hierarchy: no cross-contract import, no shared module importing a contract, no unclassified module (rule and rationale in `README.md`) | 3 contracts, 96 modules, 94 non-root | sub-second |
...
Twenty-five helpers do the actual work and are not gates in their own right — they are
