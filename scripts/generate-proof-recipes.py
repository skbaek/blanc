...
def self_test(root: Path) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="proof-recipes-") as directory:
        ...
        rejected_matcher("unimplemented-leaf-head", replace_once(leaf_original, resume_trigger,
        ...
        rejected_matcher("duplicate-trigger-ownership", replace_once(leaf_original,
            resume_trigger, json.dumps(core_trigger), "duplicate-trigger-ownership"),
    ...
    try:
        ...
        if args.self_test:
            ...
            print(
                ...
                "matcher-ownership, trigger-dispatch, Jaune-dispatch, "
                "harness-enumeration, and symbol controls live"
            )
