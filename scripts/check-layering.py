...
SHARED = ["Basic", "Semantics", "CommonCore", "MachineDataFacts", "CreationArtifact", "ProofRecipesGenerated", "ProofRecipeTactic", "Tactics", "CommonProofs", "Ladder", "Upgrade",
          ...
          "RevertPayload", "CompiledWalkInversion", "CompiledStackSafety", "AbstractStackSafety", "AbstractStackTransfer", "AbstractStackCertificate", "LinearDispatch", "LinearDispatchCorrectness",
