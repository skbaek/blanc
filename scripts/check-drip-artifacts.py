...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        if args.self_test:
            ...
            print(
                f"OK — DRIP artifacts: runtime={RUNTIME_SIZE}, prefix={PREFIX_SIZE}, "
                f"creation={CREATION_SIZE}, EIP-3860 headroom={INITCODE_LIMIT - CREATION_SIZE}; "
                "constructor semantics exact"
            )
        return 0
