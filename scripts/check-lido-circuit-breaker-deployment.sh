...
echo "OK — Lido CircuitBreaker direct deployment root (21 pins; 13 reduction certificates; 213 fragments; 161 exact axiom probes; 64 source mutants + 2 Lean controls; 18 finite assertions + 26 finite mutants; 1 strict block)"
