...
echo "OK — Lido CircuitBreaker direct deployment root (17 pins; 149 fragments; 161 exact axiom probes; 39 source mutants + 2 Lean controls; 18 finite assertions + 26 finite mutants; 1 strict block)"
