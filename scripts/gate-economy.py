...
def render() -> str:
    ...
    lines += [
        ...
        "- Eleven gates landed after the launch inventory: the cheap BeaconDeposit assurance",
        ...
        "  does not rerun the EELS/Jaune body. The PRORATA WETH vault artifact row at position 62",
        "  binds its new family-owned runtime, ABI and compile witness; the exact-call boundary",
        "  row at position 63 binds the downstream composition, effects and source staging",
        "  (both now at 69 and 70). The PRORATA WETH vault's six evidence rows run early among",
        "  the cheap static gates: the vendored-reference identity, the independent oracle, the",
        "  two-runtime differential, and their three harness self-tests.",
        "  The final population is therefore 53 + 5 + 11 = 69; no required content was dropped.",
