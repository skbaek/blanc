...
def render() -> str:
    ...
    lines += [
        ...
        "- Seven gates landed after the launch inventory: BeaconDeposit assurance runs early;",
        ...
        "  current-mainnet consumer follows it at position 65.",
        "  The final population is therefore 53 + 5 + 7 = 65; no required content was dropped.",
        ...
        "  certificate remain local merge-candidate rows. The prerequisite column also records nested launch composition",
