...
def render() -> str:
    ...
    lines += [
        ...
        "- Thirteen gates landed after the launch inventory: BeaconDeposit assurance runs early;",
        ...
        "  self-tests.",
        "  The final population is therefore 53 + 5 + 13 = 71; no required content was dropped.",
