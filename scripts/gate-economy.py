...
def render() -> str:
    ...
    lines += [
        ...
        "- Eight gates landed after the launch inventory: BeaconDeposit assurance runs early;",
        ...
        "  target-independent DRIP evidence enters at position 64; and the isolated DRIP",
        "  current-mainnet consumer follows it at position 65; and the TWG pinned-target row",
        "  replays composed and family pause/query arms under literal BPO2 at position 66.",
        "  The final population is therefore 53 + 5 + 8 = 66; no required content was dropped.",
        "- CI makes the same five splits and adds the assurance, WETH10 current-mainnet, and DRIP",
        "  rows, so its registered command population moves from 34 to 41. Deployment and the DRIP",
        "  certificate and TWG pinned-target replay remain local merge-candidate rows. The prerequisite column also records nested launch composition",
